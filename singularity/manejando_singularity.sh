...
# Ejecuta el notebook pi.ipynb que tienes en el propio contenedor my-python.sif de Singularity (que está en /app)
singularity exec my-python.sif jupyter notebook app/pi-solution-alumno25.ipynb
